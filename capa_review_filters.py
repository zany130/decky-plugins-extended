...
def install(core: ModuleType) -> ModuleType:
    ...
    def discover_binaries(
        ...
        discovered = raw_discover(core_module, extract_dir)
        for item in discovered:
            ...
            if (
                ...
                # The direct vivisect-backed CLI integration does not analyze
                # these corpus samples reliably. Keep the binary visible while
                # avoiding a misleading crash or timeout in the primary budget.
